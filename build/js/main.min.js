...
/* harmony import */ var _modules_gym_video_launch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/gym-video-launch */ "./js/modules/gym-video-launch.js");
/* harmony import */ var _modules_gym_video_launch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_gym_video_launch__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_subscription_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/subscription-tabs */ "./js/modules/subscription-tabs.js");
/* harmony import */ var _modules_subscription_tabs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_subscription_tabs__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_coaches_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/coaches-slider */ "./js/modules/coaches-slider.js");
/* harmony import */ var _modules_rewiews_carousel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/rewiews-carousel */ "./js/modules/rewiews-carousel.js");
/* harmony import */ var _modules_form_tel_mask_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form-tel-mask.js */ "./js/modules/form-tel-mask.js");
/* harmony import */ var _modules_form_tel_mask_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_form_tel_mask_js__WEBPACK_IMPORTED_MODULE_6__);
...
var coachesSlider = document.querySelector('.coaches__swiper');
if (coachesSlider) {
  // eslint-disable-next-line
  var swiper = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"](coachesSlider, {
  ...
  var swiperSlideDublicates = document.querySelectorAll('.swiper-slide-duplicate');
  var _iterator = _createForOfIteratorHelper(swiperSlideDublicates),
    _step;
  try {
...
if (phoneInputs) {
  document.addEventListener('DOMContentLoaded', function () {
    var eventCallback = function eventCallback(e) {
      ...
      var matrixDef = '+7(___) ___-__-__';
      var matrix = pattern ? pattern : matrixDef;
      var i = 0;
...
/***/ "./js/modules/gym-video-launch.js":
/*!****************************************!*\
  !*** ./js/modules/gym-video-launch.js ***!
  \****************************************/
/*! no static exports found */
...
var gymVideoElement = document.querySelector('.gym__video');
var gymVideoButtonElement = document.querySelector('.gym__video-button');
var gymVideoWrapperElement = document.querySelector('.gym__video-wrapper');
...
/***/ "./js/modules/rewiews-carousel.js":
/*!****************************************!*\
  !*** ./js/modules/rewiews-carousel.js ***!
  \****************************************/
/*! no exports provided */
...
var reviewsSlider = document.querySelector('.reviews__swiper');
if (reviewsSlider) {
  // eslint-disable-next-line
  var swiper = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"](reviewsSlider, {
    direction: 'horizontal',
    slidesPerView: 1,
    keyboard: {
      enabled: true
...
/***/ "./js/modules/subscription-tabs.js":
/*!*****************************************!*\
  !*** ./js/modules/subscription-tabs.js ***!
  \*****************************************/
/*! no static exports found */
...
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
var tabButtonNodeList = document.querySelectorAll('.subscription__tab-button');
var subscriptionListNodeList = document.querySelectorAll('.subscription__list');
if (tabButtonNodeList.length !== 0 && subscriptionListNodeList.length !== 0 && tabButtonNodeList.length === subscriptionListNodeList.length) {
  ...
  var _iterator = _createForOfIteratorHelper(subscriptionListNodeList),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var element = _step.value;
  ...
  tabButtonNodeList.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      document.querySelector(".subscription__list[data-target=\"".concat(item.dataset.target, "\"]")).classList.add('subscription__list--active');
    });
  });
}
    ...
    if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || r.activeElement && r.activeElement.nodeName && ("input" === r.activeElement.nodeName.toLowerCase() || "textarea" === r.activeElement.nodeName.toLowerCase()))) {
      if (t.params.keyboard.onlyInViewport && (d || c || p || u || h || m)) {
        ...
        var _a10 = t.$el,
          ...
          _o3 = n.innerHeight,
          _d2 = t.$el.offset();
        s && (_d2.left -= t.$el[0].scrollLeft);
        var _c = [[_d2.left, _d2.top], [_d2.left + _i8, _d2.top], [_d2.left, _d2.top + _r4], [_d2.left + _i8, _d2.top + _r4]];
...
function HashNavigation(e) {
  ...
  var o = function o() {
    ...
    d = function d() {
      if (r && t.params.hashNavigation.enabled) if (t.params.hashNavigation.replaceState && l.history && l.history.replaceState) l.history.replaceState(null, null, "#".concat(t.slides.eq(t.activeIndex).attr("data-hash")) || false), a("hashSet");else {
  ...
  effectInit({
    ...
    setTranslate: function setTranslate() {
      ...
      for (var _e80 = 0; _e80 < a.length; _e80 += 1) {
        ...
        var _d3 = Math.max(Math.min(_t46[0].progress, 1), -1);
        var _h = 0,
          _f = 0,
          g = 0;
        ...
        _d3 <= 1 && _d3 > -1 && (m = 90 * _s36 + 90 * _d3, l && (m = 90 * -_s36 - 90 * _d3)), _t46.transform(v), c.slideShadows && i(_t46, _d3, p);
      }
      if (s.css({
